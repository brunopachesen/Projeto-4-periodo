...
--
-- Table structure for table `tb_cli_auto_conc`
--

DROP TABLE IF EXISTS `tb_cli_auto_conc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_cli_auto_conc` (
  `id_cli_auto_conc` int(11) NOT NULL AUTO_INCREMENT,
  `id_cli` int(11) NOT NULL,
  `id_auto` int(11) NOT NULL,
  `id_conc` int(11) NOT NULL,
  PRIMARY KEY (`id_cli_auto_conc`),
  KEY `id_cli` (`id_cli`),
  KEY `id_auto` (`id_auto`),
  KEY `id_conc` (`id_conc`),
  CONSTRAINT `tb_cli_auto_conc_ibfk_1` FOREIGN KEY (`id_cli`) REFERENCES `tb_cliente` (`id_cli`),
  CONSTRAINT `tb_cli_auto_conc_ibfk_2` FOREIGN KEY (`id_auto`) REFERENCES `tb_automovel` (`id_auto`),
  CONSTRAINT `tb_cli_auto_conc_ibfk_3` FOREIGN KEY (`id_conc`) REFERENCES `tb_concessionaria` (`id_conc`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_cli_auto_conc`
--

LOCK TABLES `tb_cli_auto_conc` WRITE;
/*!40000 ALTER TABLE `tb_cli_auto_conc` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_cli_auto_conc` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tb_forn_mont`
--

DROP TABLE IF EXISTS `tb_forn_mont`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_forn_mont` (
  `id_forn_mont` int(11) NOT NULL AUTO_INCREMENT,
  `id_forn` int(11) NOT NULL,
  `id_mont` int(11) NOT NULL,
  PRIMARY KEY (`id_forn_mont`),
  KEY `id_forn` (`id_forn`),
  KEY `id_mont` (`id_mont`),
  CONSTRAINT `tb_forn_mont_ibfk_1` FOREIGN KEY (`id_forn`) REFERENCES `tb_fornecedor` (`id_forn`),
  CONSTRAINT `tb_forn_mont_ibfk_2` FOREIGN KEY (`id_mont`) REFERENCES `tb_montadora` (`id_mont`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_forn_mont`
--

LOCK TABLES `tb_forn_mont` WRITE;
/*!40000 ALTER TABLE `tb_forn_mont` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_forn_mont` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-02-22 21:03:31
